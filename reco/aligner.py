...
class Bowtie2Aligner:
    ...
    def __init__(self, logger=None, seed_length=Config.BOWTIE2_SEED_LENGTH, seed_mismatch=Config.BOWTIE2_SEED_MISMATCH, interval_function=Config.BOWTIE2_INTERVAL_FUNCTION,
                 bowtie2_index=None, final_trimmed_file=None, sam_file=None):
        self.logger = logger
